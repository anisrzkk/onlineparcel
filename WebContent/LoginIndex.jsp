...
.login-wrap{
	...
	min-height:670px;
	position:relative;
	 background-image: url("parcel.jpg");
	box-shadow:0 12px 15px 0 rgba(0,0,0,.30),0 17px 30px 0 rgba(0,0,0,.39);
}
.login-html{
	width:100%;
	height:100%;
...
<div class="login-wrap">
	<div class="login-html">
		...
		<input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab">STAFF</label>
		<div class="login-form">
		
			<div  class="sign-in-htm">
			<form action="studentprocess.jsp" method="post" >
				<div class="group">
                    <h5>Please fill form below to check your parcel.</h5>
			...
			<form action="loginprocesss.jsp" method="post" >
				<div class="group">
					<br><label for="user" class="label"> Username </label>
					<input id="user" name="username" type="text" class="input" placeholder="Staff ID" required>
				</div>
				<div class="group">
